<template>
    <div id="app">
        ...
        <div id="prediction-wrapper">
            ...
            <div class="prediction" v-for="color in colors" v-on:click="prediction = color.hex"
                 v-bind:style="{backgroundColor: color.hex}" v-bind:class="{ active: prediction === color.hex }"></div>
        </div>
  ...
  export default {
    ...
    methods: {
      ...
      reset() {
        ...
        let play_audio = document.getElementById("play-audio");
        loss_audio.pause();
